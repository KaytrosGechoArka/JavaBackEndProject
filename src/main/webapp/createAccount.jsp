...
<body>
	...
	<form action="StudentRegistrationHandler" method="post" class="container" id="form">
		...
		<!-- Start Of Check Form -->
		<div class="container-fluid my-4 ms-4">
		...
		<div class="container-fluid d-inline w-100">
			<button type="submit" class="btn  bg-info text-white me-3 fs-4 p-2 px-5 rounded-0 float-end" name="register">Submit</button>
